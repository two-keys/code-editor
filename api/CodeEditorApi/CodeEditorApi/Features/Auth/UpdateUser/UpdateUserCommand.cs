...
namespace CodeEditorApi.Features.Auth.UpdateUser
{
    ...
    public class UpdateUserCommand : IUpdateUserCommand
    {
        ...
        public async Task<ActionResult<string>> ExecuteAsync(UpdateUserBody updateUserBody)
        {
            ...
            if (!updateUserBody.Name.Equals(user.Name) && (await _getUser.GetUserByName(updateUserBody.Name) != null))
            {
            ...
            if (!updateUserBody.Email.Equals(user.Email) && (await _getUser.ExecuteAsync(updateUserBody.Email) != null))
            {
